package cn.jiguang.demo.baselibrary.arouter;
...
public class ServiceConstant {
    ...
    public static final String SERVICE_JAD = "/jad/service";
    public static final String SERVICE_JOPERATE = "/joperate/service";
